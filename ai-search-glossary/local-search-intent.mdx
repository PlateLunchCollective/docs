...
description: "Local search intent is the underlying goal of a user query that includes a geographic component — the desire to find a business, service, product, or information relevant to a specific location."
---
