...
description: "Clickstream data is the record of a user's sequential interactions with digital content — the pages visited, links clicked, time spent, and paths taken through a website or across the web."
---
