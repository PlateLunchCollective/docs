...
description: "Query expansion is the process by which an AI system broadens or reformulates a user's query to retrieve a wider set of relevant documents before generating a response."
---
