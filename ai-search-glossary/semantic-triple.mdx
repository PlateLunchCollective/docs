...
description: "A semantic triple is a fundamental unit of knowledge representation in the form of subject–predicate–object — for example, \"Plate Lunch Collective – is located in – Hawaii.\""
---
