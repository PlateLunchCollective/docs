---
title: "ClaudeBot"
description: "ClaudeBot is Anthropic's web crawler primarily used to gather training data for its AI models, which contributes to the content available for Claude AI responses."
---
