...
description: "Content accessibility, in the AI SEO context, is the degree to which a page's content is available in the initial HTML response — without requiring JavaScript execution"
---
