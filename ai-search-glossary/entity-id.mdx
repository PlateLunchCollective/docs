---
title: "Entity ID"
description: "An entity ID is a unique, persistent identifier assigned to an entity within a structured knowledge system — such as a Wikidata QID, a Google Knowledge Graph ID, or a schema.org identifier."
---
