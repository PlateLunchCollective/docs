...
description: "An answer snippet is a concise, self-contained passage within a web page that directly answers a specific question — optimized for extraction by AI systems and featured snippet selection."
---
