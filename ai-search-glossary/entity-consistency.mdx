...
description: "Entity consistency is the degree to which a brand's name, description, attributes, and relationships are represented uniformly across all digital platforms where the entity appears"
---
