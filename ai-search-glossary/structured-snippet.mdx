...
description: "A structured snippet is a type of rich result that displays a table or list of specific attributes about a product, service, or entity — enabled by structured data markup."
---
