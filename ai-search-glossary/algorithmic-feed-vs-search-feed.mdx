...
description: "An algorithmic feed is a social platform's default content stream — populated by the platform's recommendation system based on user behavior, engagement signals, and predicted interest."
---
