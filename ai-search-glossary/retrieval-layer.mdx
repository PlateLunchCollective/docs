...
description: "The retrieval layer is the component of an AI search system responsible for finding and returning relevant content from an index in response to a query"
---
