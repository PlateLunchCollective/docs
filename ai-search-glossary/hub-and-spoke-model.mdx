...
description: "The hub and spoke model is a content architecture in which a central hub page covers a topic broadly, linking outward to spoke pages that each address a specific subtopic in depth"
---
