...
description: "A brand coverage gap is a topic, query type, or subject area relevant to a brand's domain where the brand has no content, no entity signal, and no AI citation presence"
---
