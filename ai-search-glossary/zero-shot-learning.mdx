...
description: "Zero-shot learning is a machine learning paradigm in which a model performs tasks it was never explicitly trained to do, relying on generalized knowledge from pre-training"
---
