...
description: "A foundation model is a large AI model trained on broad, general-purpose data that serves as the base for a wide range of downstream applications"
---
