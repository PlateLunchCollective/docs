...
description: "Model grounding is the practice of connecting an AI model's outputs to specific, verifiable external data sources — either through retrieval-augmented generation, tool use, or real-time web access"
---
