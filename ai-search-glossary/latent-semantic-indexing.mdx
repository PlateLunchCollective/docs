...
description: "Latent Semantic Indexing (LSI) is an older information retrieval technique that identifies relationships between terms and concepts in a document corpus using singular value decomposition."
---
